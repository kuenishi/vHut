...
package jp.co.ntts.vhut.ai.application
{
	 ...
	 */
	public class ActivateApplicationInstanceByIdCommand extends BaseCommand
	{
		[Inject]
		/**
		 ...
		 * コンストラクタ.
		 */
		public function ActivateApplicationInstanceByIdCommand()
		{
			super(
				"AIG",
				"jp.co.ntts.vhut.ai.application.ActivateApplicationInstanceByIdCommand",
				"ApplicationInstanceGroupService.activateApplicationInstanceById"
			);
		}
		...
		public function execute(event:AiEvent):AsyncToken
		{
			...
			_request();
			return service.activateApplicationInstanceById(event.ai.id) as AsyncToken;
		}
