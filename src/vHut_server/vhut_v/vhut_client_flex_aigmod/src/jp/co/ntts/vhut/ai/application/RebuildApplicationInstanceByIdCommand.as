...
package jp.co.ntts.vhut.ai.application
{
	 ...
	 */
	public class RebuildApplicationInstanceByIdCommand extends BaseCommand
	{
		[Inject]
		/**
		 ...
		 * コンストラクタ.
		 */
		public function RebuildApplicationInstanceByIdCommand()
		{
			super(
				"AIG",
				"jp.co.ntts.vhut.ai.application.RebuildApplicationInstanceByIdCommand",
				"ApplicationInstanceGroupService.rebuildApplicationInstanceById"
			);
		}
		...
		public function execute(event:AiEvent):AsyncToken
		{
			...
			_request();
			return service.rebuildApplicationInstanceById(event.ai.id) as AsyncToken;
		}
