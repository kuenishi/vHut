...
package jp.co.ntts.vhut.aig.application
{
	 ...
	 */
	public class CreateApplicationInstanceGroupCommand extends BaseCommand
	{
		[Inject]
		/**
		 ...
		 * コンストラクタ.
		 */
		public function CreateApplicationInstanceGroupCommand()
		{
			super(
				"AIG",
				"jp.co.ntts.vhut.aig.application.CreateApplicationInstanceGroupCommand",
				"ApplicationInstanceGroupService.createApplicationInstanceGroup"
			);
		}
		...
		public function execute(event:AigEvent):AsyncToken
		{
			...
			_request();
			return service.createApplicationInstanceGroup(event.aig) as AsyncToken;
		}
