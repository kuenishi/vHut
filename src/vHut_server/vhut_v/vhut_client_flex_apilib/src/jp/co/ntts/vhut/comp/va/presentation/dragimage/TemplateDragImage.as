...
package jp.co.ntts.vhut.comp.va.presentation.dragimage
{
	 ...
	 */
	public class TemplateDragImage extends DragImage
	{
		public function TemplateDragImage()
		{
			super();
			addEventListener(MouseEvent.MOUSE_DOWN, onMouseDownHandler);

			setStyle("skinClass", TemplateDragImageSkin);
		}

		override protected function get dragSource():DragSource
		{
			var result:DragSource = new DragSource();
			result.addData( data, VaDragDataType.BASE_TEMPLATE.toString() );
		...
		{
			var result:VmItemRenderer = new VmItemRenderer();
