...
package jp.co.ntts.vhut.entity {
    ...
    [Bindable]
    [RemoteClass(alias="jp.co.ntts.vhut.entity.ApplicationInstanceVm")]
	/**
	 * ApplicationInstanceVm Entity Class.
	 * <p></p>
	 *
	 * <p>
	 ...
	 */
    public class ApplicationInstanceVm extends ApplicationInstanceVmBase implements IVaElement
	{
		public static const UPDATE_LINK_LIST:String = "updateLinkList";

		public function ApplicationInstanceVm()
		{
			super();
			initializeLinkList();
		}
		...
		override public function set applicationInstanceVmSecurityGroupMapList(value:ArrayCollection):void {
			...
			{
				if(item.applicationInstanceVmId == id)
				{
					item.applicationInstanceVm = this;
				}
			}
		}
		...
		public function get pos():Point
		{
			...
			return applicationInstance.topology.getVmPos(privateId);
		}
		public function set pos(value:Point):void
		{
			if(applicationInstance != null)
				applicationInstance.topology.setVmPos(privateId, value);
		}
