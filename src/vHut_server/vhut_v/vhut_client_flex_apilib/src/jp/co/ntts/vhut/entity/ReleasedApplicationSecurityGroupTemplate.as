...
package jp.co.ntts.vhut.entity {
    ...
    [Bindable]
    [RemoteClass(alias="jp.co.ntts.vhut.entity.ReleasedApplicationSecurityGroupTemplate")]
	/**
	 * ReleasedApplicationSecurityGroupTemplate Entity Class.
	 * <p></p>
	 *
	 * <p>
	 ...
	 */
    public class ReleasedApplicationSecurityGroupTemplate extends ReleasedApplicationSecurityGroupTemplateBase implements IVaElement
	{
		public static const UPDATE_LINK_LIST:String = "updateLinkList";

		public function ReleasedApplicationSecurityGroupTemplate()
		{
			super();
			initializeLinkList();
		}
		...
		override public function set releasedApplicationTemplateSecurityGroupMapList(value:ArrayCollection):void {
			...
			{
				if(item.releasedApplicationSecurityGroupTemplateId == id)
				{
					item.releasedApplicationSecurityGroupTemplate = this;
				}
			}
		}
		...
		public function get pos():Point
		{
			...
			return releasedApplication.topology.getSgPos(privateId);
		}
		public function set pos(value:Point):void
		{
			if(releasedApplication != null)
				releasedApplication.topology.setSgPos(privateId, value);
		}
