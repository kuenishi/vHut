...
package jp.co.ntts.vhut.app.application
{
	 ...
	 */
	public class ActivateApplicationByIdCommand extends BaseCommand
	{
		[Inject]
		/**
		 ...
		 * コンストラクタ.
		 */
		public function ActivateApplicationByIdCommand()
		{
			super(
				"APP",
				"jp.co.ntts.vhut.app.application.ActivateApplicationByIdCommand",
				"ApplicationService.activateApplicationById"
			);
		}
		...
		public function execute(event:ApplicationEvent):AsyncToken
		{
			...
			_request();
			return service.activateApplicationById(event.application.id) as AsyncToken;
		}
