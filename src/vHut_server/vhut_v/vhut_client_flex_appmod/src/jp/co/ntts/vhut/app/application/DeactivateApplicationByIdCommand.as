...
package jp.co.ntts.vhut.app.application
{
	 ...
	 */
	public class DeactivateApplicationByIdCommand extends BaseCommand
	{
		[Inject]
		/**
		 ...
		 * コンストラクタ.
		 */
		public function DeactivateApplicationByIdCommand()
		{
			super(
				"APP",
				"jp.co.ntts.vhut.app.application.DeactivateApplicationByIdCommand",
				"ApplicationService.deactivateApplicationById"
			);
		}
		...
		public function execute(event:ApplicationEvent):AsyncToken
		{
			...
			_request();
			return service.deactivateApplicationById(event.application.id) as AsyncToken;
		}
