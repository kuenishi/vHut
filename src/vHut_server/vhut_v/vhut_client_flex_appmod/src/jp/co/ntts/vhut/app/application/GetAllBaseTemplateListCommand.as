...
package jp.co.ntts.vhut.app.application
{
	 ...
	 */
	public class GetAllBaseTemplateListCommand extends BaseCommand
	{
		[Inject]
		/**
		 ...
		 * コンストラクタ.
		 */
		public function GetAllBaseTemplateListCommand()
		{
			super(
				"APP",
				"jp.co.ntts.vhut.app.application.GetAllBaseTemplateListCommand",
				"TemplatesService.getAllBaseTemplateListCommand"
			);
		}
		...
		public function execute(event:GetAllEvent):AsyncToken
		{
			...
			_request();
			return service.getAllBaseTemplateList() as AsyncToken;
		}
		...
		public function result(items:IList):void
		{
			_response(items);
			cache.clear();
			templates.baseTemplates = cache.synchronize(items);
