...
package jp.co.ntts.vhut.app.application
{
	 ...
	 */
	public class GetAllSpecTemplateAbstractionListCommand extends BaseCommand
	{
		[Inject]
		/**
		 ...
		 * コンストラクタ.
		 */
		public function GetAllSpecTemplateAbstractionListCommand()
		{
			super(
				"APP",
				"jp.co.ntts.vhut.app.application.GetAllSpecTemplateAbstractionListCommand",
				"TemplatesService.getAllSpecTemplateAbstractionListCommand"
			);
		}
		...
		public function execute(event:GetAllEvent):AsyncToken
		{
			...
			_request();
			return service.getAllSpecAbstractionList() as AsyncToken;
		}
