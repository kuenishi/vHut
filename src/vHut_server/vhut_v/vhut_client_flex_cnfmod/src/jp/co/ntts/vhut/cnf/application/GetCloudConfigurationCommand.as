...
package jp.co.ntts.vhut.cnf.application
{
	 ...
	 */
	public class GetCloudConfigurationCommand extends BaseCommand
	{
		[Inject]
		/**
		 * パフォーマンス情報の管理クラス.
		 ...
		 * コンストラクタ.
		 */
		public function GetCloudConfigurationCommand()
		{
			super(
				"CNF",
				"jp.co.ntts.vhut.cnf.application.GetCloudConfigurationCommand",
				"ConfigurationService.getCloudConfiguration"
			);
		}
		...
		public function execute(event:GetEvent):AsyncToken
		{
			...
			_request();
			return service.getCloudConfiguration() as AsyncToken;
		}
		 ...
		 * @return
		 */
		public function result(item:CloudConfig):void
		{
			_response(item);
			configs.cloudConfig = item;
		}
