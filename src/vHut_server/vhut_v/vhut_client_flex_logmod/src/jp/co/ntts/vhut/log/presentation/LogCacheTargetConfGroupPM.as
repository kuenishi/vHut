...
package jp.co.ntts.vhut.log.presentation
{
	...
	/**
	 * ログをキャッシュするターゲットの設定を行うためのコンポーネントのプレゼンテーションモデル.
	 * 
	 * <p>
	 ...
	 */
	public class LogCacheTargetConfGroupPM extends EventDispatcher
	{
		/** @private ロガー */
		private static var logger:ILogger=Log.getLogger("jp.co.ntts.vhut.log.presentation.LogCacheTargetConfGroupPM");

		function LogCacheTargetConfGroupPM()
		{
		 ...
		 * ロギングターゲット. 
		 */
		public var target:LogCacheTarget;
		...
		private var _isTargetEnable:Boolean=true;
