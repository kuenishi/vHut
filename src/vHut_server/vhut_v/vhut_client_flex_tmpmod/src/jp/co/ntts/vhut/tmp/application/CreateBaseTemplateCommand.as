...
package jp.co.ntts.vhut.tmp.application
{
	 ...
	 */
	public class CreateBaseTemplateCommand extends BaseCommand
	{
		[Inject]
		/**
		 * 概要情報の管理クラス.
		 ...
		 * コンストラクタ.
		 */
		public function CreateBaseTemplateCommand()
		{
			super(
				"TMP",
				"jp.co.ntts.vhut.tmp.application.CreateBaseTemplateCommand",
				"BaseTemplateService.createBaseTemplate"
			);
		}
		...
		public function execute(event:TmpEvent):AsyncToken
		{
			...
			_request();
			return service.createBaseTemplate(event.baseTemplate) as AsyncToken;
		}
