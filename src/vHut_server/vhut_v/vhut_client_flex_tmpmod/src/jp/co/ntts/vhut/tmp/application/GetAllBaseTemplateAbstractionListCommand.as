...
package jp.co.ntts.vhut.tmp.application
{
	 ...
	 */
	public class GetAllBaseTemplateAbstractionListCommand extends BaseCommand
	{
		[Inject]
		/**
		 * 概要情報の管理クラス.
		 ...
		 * コンストラクタ.
		 */
		public function GetAllBaseTemplateAbstractionListCommand()
		{
			super(
				"TMP",
				"jp.co.ntts.vhut.tmp.application.GetAllBaseTemplateAbstractionListCommand",
				"BaseTemplateService.getAllBaseTemplateAbstractionList"
			);
		}
		...
		public function execute(event:GetAllEvent):AsyncToken
		{
			...
			_request();
			return service.getAllBaseTemplateAbstractionList() as AsyncToken;
		}
		...
		{
			_response(items);
			baseTempaltes.baseTemplates = cache.synchronize(items);
		}
