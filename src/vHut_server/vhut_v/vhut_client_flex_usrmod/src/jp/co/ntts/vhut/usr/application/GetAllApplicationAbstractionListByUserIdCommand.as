...
package jp.co.ntts.vhut.usr.application
{
	...
	public class GetAllApplicationAbstractionListByUserIdCommand extends BaseCommand
	{
		...
		public function GetAllApplicationAbstractionListByUserIdCommand()
		{
			super(
				"USR",
				"jp.co.ntts.vhut.usr.application.GetAllApplicationAbstractionListByUserIdCommand",
				"ApplicationService.getAllApplicationAbstractionListByUserId"
			);
		}
		...
		public function execute(event:GetByIdEvent):AsyncToken
		{
			...
			_request();
			return service.getAllApplicationAbstractionListByUserId(event.id) as AsyncToken;
		}
