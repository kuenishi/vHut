...
package jp.co.ntts.vhut.usr.application
{
	 ...
	 */
	public class GetAllApplicationInstanceGroupAbstractionListByUserIdCommand extends BaseCommand
	{
		[Inject]
		/**
		 * 概要情報の管理クラス.
		 ...
		 * コンストラクタ.
		 */
		public function GetAllApplicationInstanceGroupAbstractionListByUserIdCommand()
		{
			super(
				"USR",
				"jp.co.ntts.vhut.usr.application.GetAllApplicationInstanceGroupAbstractionListByUserIdCommand",
				"ApplicationInstanceGroupService.getApplicationInstanceGroupAbstractionListByUserId"
			);
		}
		...
		public function execute(event:GetByIdEvent):AsyncToken
		{
			...
			_request();
			return service.getApplicationInstanceGroupAbstractionListByUserId(event.id) as AsyncToken;
		}
