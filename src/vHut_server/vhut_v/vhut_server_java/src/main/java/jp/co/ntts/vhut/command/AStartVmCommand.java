 ...
 * -->
 */
public class AStartVmCommand extends AbstractAsyncCloudDriverCommand {
    private static final VhutLogger logger = VhutLogger.getLogger(AStartVmCommand.class);
     ...
     * デフォルトコンストラクタ.
     */
    public AStartVmCommand() {
        operation = CommandOperation.START_VM_ASYNC;
    }
