 ...
 * -->
 */
public class SShutdownVmCommand extends AbstractCloudDriverCommand {
    private static final VhutLogger logger = VhutLogger.getLogger(SShutdownVmCommand.class);
     ...
     * デフォルトコンストラクタ.
     */
    public SShutdownVmCommand() {
        operation = CommandOperation.SHUTDOWN_VM_SYNC;
    }
