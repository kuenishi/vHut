 ...
 * -->
 */
public class SStopVmCommand extends AbstractCloudDriverCommand {
    private static VhutLogger logger = VhutLogger.getLogger(AStopVmCommand.class);
     ...
     * デフォルトコンストラクタ.
     */
    public SStopVmCommand() {
        operation = CommandOperation.STOP_VM_SYNC;
    }
