 ...
 */
public class NetworkAdapterTemplateDto {
     ...
     */
    public static NetworkAdapterTemplateDto newNetworkAdapterTemplateDto(Map<String, Object> map) throws ClassCastException {
        NetworkAdapterTemplateDto dto = new NetworkAdapterTemplateDto();
