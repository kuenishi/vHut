...
/**
 * {@link ApplicationInstanceVm}のプロパティ名の集合です。
 * 
...
public class ApplicationInstanceVmNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _ApplicationInstanceVmNames extends PropertyName<ApplicationInstanceVm> {

        /**
         * インスタンスを構築します。
         */
        public _ApplicationInstanceVmNames() {
        }
         ...
         *            名前
         */
        public _ApplicationInstanceVmNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ApplicationInstanceVmNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
