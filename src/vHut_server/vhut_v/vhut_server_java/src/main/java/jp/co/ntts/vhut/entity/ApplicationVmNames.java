...
/**
 * {@link ApplicationVm}のプロパティ名の集合です。
 * 
...
public class ApplicationVmNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _ApplicationVmNames extends PropertyName<ApplicationVm> {

        /**
         * インスタンスを構築します。
         */
        public _ApplicationVmNames() {
        }
         ...
         *            名前
         */
        public _ApplicationVmNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ApplicationVmNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
