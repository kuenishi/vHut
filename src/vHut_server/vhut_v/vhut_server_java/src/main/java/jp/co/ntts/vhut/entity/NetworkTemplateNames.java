 ...
 */
@Generated(value = { "S2JDBC-Gen 2.4.42", "org.seasar.extension.jdbc.gen.internal.model.NamesModelFactoryImpl" }, date = "2011/07/15 12:12:43")
public class NetworkTemplateNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _NetworkTemplateNames extends PropertyName<SecurityGroupTemplate> {

        /**
         * インスタンスを構築します。
         */
        public _NetworkTemplateNames() {
        }
         ...
         *            名前
         */
        public _NetworkTemplateNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _NetworkTemplateNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
