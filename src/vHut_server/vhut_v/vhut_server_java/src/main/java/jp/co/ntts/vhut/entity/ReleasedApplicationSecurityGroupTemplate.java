...
/**
 * <p>{@link jp.co.ntts.vhut.entity.ReleasedApplication}に{@link jp.co.ntts.vhut.entity.SecurityGroupTemplate}
 * を格納するためのエンティティクラス.
 * <br>
 *
 * @version 1.0.0
 ...
 */
@Entity
public class ReleasedApplicationSecurityGroupTemplate implements Serializable, IIdentifiableEntity {
    ...
    /** releasedApplicationTemplateSecurityGroupMapList関連プロパティ */
    @OneToMany(mappedBy = "releasedApplicationSecurityGroupTemplate")
    public List<ReleasedApplicationTemplateSecurityGroupMap> releasedApplicationTemplateSecurityGroupMapList;
