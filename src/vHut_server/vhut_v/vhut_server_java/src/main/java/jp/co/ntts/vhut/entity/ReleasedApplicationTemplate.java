...
/**
 * ReleasedApplicationTemplateエンティティクラス
 *
...
public class ReleasedApplicationTemplate implements Serializable, IIdentifiableEntity {
    ...
    @ManyToOne
    @JoinColumn(name = "released_application_id", referencedColumnName = "id")
    public ReleasedApplication releasedApplication;

    /** releasedApplicationTemplateSecurityGroupMapList関連プロパティ */
    @OneToMany(mappedBy = "releasedApplicationTemplate")
