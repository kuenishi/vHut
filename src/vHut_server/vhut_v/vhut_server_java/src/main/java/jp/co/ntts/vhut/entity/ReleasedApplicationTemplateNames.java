...
/**
 * {@link ReleasedApplicationTemplate}のプロパティ名の集合です。
 * 
...
public class ReleasedApplicationTemplateNames {
     ...
     * @author S2JDBC-Gen
     */
    public static class _ReleasedApplicationTemplateNames extends PropertyName<ReleasedApplicationTemplate> {

        /**
         * インスタンスを構築します。
         */
        public _ReleasedApplicationTemplateNames() {
        }
         ...
         *            名前
         */
        public _ReleasedApplicationTemplateNames(final String name) {
            super(name);
        }
         ...
         *            名前
         */
        public _ReleasedApplicationTemplateNames(final PropertyName<?> parent, final String name) {
            super(parent, name);
        }
