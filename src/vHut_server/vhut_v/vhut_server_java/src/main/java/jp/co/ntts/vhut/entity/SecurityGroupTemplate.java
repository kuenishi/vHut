...
public class SecurityGroupTemplate implements Serializable, IIdentifiableEntity {
    ...
    @OneToMany(mappedBy = "securityGroupTemplate")
    public List<NetworkAdapterTemplate> networkAdapterTemplateList;


    /**
     * SecurityGroupを参照してSecurityGroupTemplateを作ります.
     * @param source SecurityGroup
     * @return SecurityGroupTemplate
     */
    public static SecurityGroupTemplate newInstance(SecurityGroup source) {
        SecurityGroupTemplate result = new SecurityGroupTemplate();
